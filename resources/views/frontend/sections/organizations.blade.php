<section class="section organizations" id="five">
    <div class="section__inner">
        ...
        <div class="section__inner-content">
            <div class="container">
                <div class="col-12">
                    <h5 class="section__title" data-aos="fade-left">{{ __('Organizations') }}</h5>
                    <h5 class="section__subtitle" data-aos="fade-right">
                        {{ __('I joined various organizations to improve myself and just as a hobby.') }}
                    </h5>

                    <div class="organizations__slider" data-aos="fade-up">
                        @foreach ($organizations as $organization)
                            <div class="organization__slider-single">
                    ...
                    <div class="organizations__slider-nav d-flex justify-content-center justify-content-sm-end">
                        <button class="next-organization-item">
                            <i class="gg-arrow-long-left"></i>
                        </button>
                        <button class="prev-organization-item">
