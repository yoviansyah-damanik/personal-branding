 <section class="section experiences" id="four">
             ...
             <svg class="background__lights" id="lines" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                 ...
                 <g class="lights">
                     ...
                     <path class="light8 light"
                         d="M125.1,514.5h-0.9v-9.7h0.9V514.5z M125.1,243.6h-0.9v-58.9h0.9V243.6z"></path>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-lg-10 col-xl-8">
                         <div class="experience__content" data-aos="fade-right">
                             <h2>Where I’ve Worked</h2>
                             <div class="experience__content-tab">
                                 <div class="experience__content-tab-btns">
                                     <a href="#exp" class="tab-btn tab-btn-active">
                                         Ericsson
                                     </a>
                                     <a href="#secondExp" class="tab-btn">
                                         Facebook
                                     </a>
                                     <a href="#thirdExp" class="tab-btn">
                                         Duff Beer
                                     </a>
                                     <a href="#fourthExp" class="tab-btn">
                                         Initech
                                     </a>
                                     <a href="#fifthExp" class="tab-btn">
                                         Hooli
                                     </a>
                                     <a href="#sixthExp" class="tab-btn">
                                         SingTel
                                     </a>
                                     <a href="#seventhExp" class="tab-btn">
                                         Fortive
                                     </a>
                                 </div>
                                 <div class="experience__content-tab-content" id="exp">
                                     <h5>Engineer <span>@Ericsson</span></h5>
                                     <p>May 2018 - Present</p>
                                     <ul>
                                         <li><i class="fa-solid fa-caret-right"></i>Write modern, performant,
                                             maintainable code for a diverse array of
                                             client and internal projects</li>
                                         <li><i class="fa-solid fa-caret-right"></i>Work with a variety of
                                             different languages, platforms, frameworks,
                                             and content management systems such as JavaScript, TypeScript,
                                             Gatsby, React, Craft, WordPress, Prismic, and Netlify</li>
                                         <li><i class="fa-solid fa-caret-right"></i>Communicate with
                                             multi-disciplinary teams of engineers, designers,
                                             producers, and clients on a daily basis</li>
                                     </ul>
                                 </div>
                                 <div class="experience__content-tab-content" id="secondExp">
                                     <h5>Engineer <span>@Facebook</span></h5>
                                 ...
                                 <div class="experience__content-tab-content" id="thirdExp">
                                     <h5>Engineer <span>@Duff Beer</span></h5>
                                 ...
                                 <div class="experience__content-tab-content" id="fourthExp">
                                     <h5>Engineer <span>@Initech</span></h5>
                                 ...
                                 <div class="experience__content-tab-content" id="fifthExp">
                                     <h5>Engineer <span>@SingTel</span></h5>
                                     <p>May 2014 - Jan 2015</p>
                                     <ul>
                                         <li><i class="fa-solid fa-caret-right"></i>Write modern, performant,
                                             maintainable code for a diverse array of
                                             client and internal projects</li>
                                 ...
                                 <div class="experience__content-tab-content" id="sixthExp">
                                     <h5>Engineer <span>@Fortive</span></h5>
                                     <p>May 2013 - Jan 2014</p>
                                     <ul>
                                         <li><i class="fa-solid fa-caret-right"></i>Write modern, performant,
                                             maintainable code for a diverse array of
                                             client and internal projects</li>
                                 ...
                                 <div class="experience__content-tab-content" id="seventhExp">
                                     <h5>Engineer <span>@Hooli</span></h5>
                                     <p>May 2012 - Jan 2013</p>
                                     <ul>
                                         <li><i class="fa-solid fa-caret-right"></i>Write modern, performant,
                                             maintainable code for a diverse array of
                                             client and internal projects</li>
