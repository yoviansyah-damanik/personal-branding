                    ...
                    <div class="col-lg-10 col-xl-9">
                        <div class="experience__content" data-aos="fade-right">
                            ...
                            <div class="experience__content-tab">
                                ...
                                @foreach ($experiences as $experience)
                                    <div class="experience__content-tab-content"
                                        id="experience-{{ $loop->iteration }}">
                                        <h5>{{ $experience->position }} <span>{{ '@' . $experience->name }}</span></h5>
                                        <p> {{ $experience->start_period_text }} -
                                            {{ $experience->end_period_text }}</p>
