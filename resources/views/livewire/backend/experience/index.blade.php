<div>
                        ...
                        <ul class="nav nav-pills align-items-center">
                            ...
                            <li class="nav-item">
                                <button class="nav-link @if ($status == 'all') active @endif"
                                    ...
                                    {{ __('All') }}
                                    <span class="badge badge-primary">{{ $experience_total }}</span>
                                </button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link @if ($status == 'drafted') active @endif"
                                    ...
                                    {{ __('Drafted') }}
                                    <span class="badge badge-primary">{{ $experience_drafted }}</span>
                                </button>
                            </li>
                            <li class="nav-item mr-3">
                                <button class="nav-link @if ($status == 'published') active @endif"
                                    ...
                                    {{ __('Published') }}
                                    <span class="badge badge-primary">{{ $experience_published }}</span>
                                </button>
                            </li>
                        </ul>
                        <a class="mt-3 mt-lg-0 btn btn-primary" href="{{ route('dashboard.experience.create') }}">
    ...
    <div class="row mt-3">
        @forelse($experiences as $experience)
            <livewire:backend.experience.item :experience="$experience" :wire:key="rand()" />
        @empty
            <div class="col-12">
