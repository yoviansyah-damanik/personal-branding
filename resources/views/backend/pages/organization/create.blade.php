    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">{{ __('Create Organization') }}</h2>
                <div class="card">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="start_period" id="start_period"
                                                    class="form-control" value="{{ old('start_period') }}" required>
                                                @error('start_period')
                                                    <div class="small text-danger">
                                                        {{ $message }}
                                                    </div>
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <input type="checkbox" name="is_end" id="is_end"
                                                                @if (old('is_end') == true) checked @endif>
                                                        </div>
                                                    </div>
                                                    <input type="date" name="end_period" id="end_period"
                                                        class="form-control" value="{{ old('end_period') }}">
                                                </div>
                                                @error('end_period')
                                                    <div class="small text-danger">
                                                        {{ $message }}
