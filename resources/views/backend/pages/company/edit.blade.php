    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">{{ __('Edit Company') }}</h2>

                <div class="card">
                    <form action="{{ route('dashboard.company.update', $company->slug) }}" method="post"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div id="image-preview" class="image-preview"
                                                    style="background-image:url('{{ $company->image_path }}'); background-size:cover; background-position:center center;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="as_known" id="as_known" class="form-control"
                                                    value="{{ old('as_known', $company->as_known) }}" required>
                                                @error('as_known')
                                                    <div class="small text-danger">
                                                        {{ $message }}
                                                    </div>
                                                ...
                                                <select name="sectors[]" class="form-control selectric" multiple="">
                                                    ...
                                                    @foreach ($sectors as $sector)
                                                        <option value="{{ $sector->id }}"
                                                            {{ in_array($sector->id, old('sectors', $company->sectors->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                            {{ $sector->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="summernote" name="description" required>{{ old('description', $company->description) }}</textarea>
                                                @error('description')
                                                    <div class="small text-danger">
                                                        {{ $message }}
                                                    </div>
