...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend-assets/css/backend.components.css') }}">
...
<body>
    ...
    <script src="{{ asset('backend-assets/library/gmaps/gmaps.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('backend-assets/js/page/utilities-contact.js') }}"></script>
