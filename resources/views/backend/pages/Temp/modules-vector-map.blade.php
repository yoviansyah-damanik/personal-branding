...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('backend-assets/library/izitoast/dist/css/iziToast.min.css') }}">
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('backend-assets/library/izitoast/dist/js/iziToast.js') }}"></script>
    ...
    <script src="{{ asset('backend-assets/library/jqvmap/dist/maps/jquery.vmap.indonesia.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('backend-assets/js/page/modules-vector-map.js') }}"></script>
@endpush
