...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('backend-assets/library/dropzone/dist/dropzone.css') }}">
@endpush
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('backend-assets/library/dropzone/dist/min/dropzone.min.js') }}"></script>
