...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('backend-assets/library/fullcalendar/dist/fullcalendar.min.css') }}">
@endpush
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('backend-assets/library/fullcalendar/dist/fullcalendar.min.js') }}"></script>
