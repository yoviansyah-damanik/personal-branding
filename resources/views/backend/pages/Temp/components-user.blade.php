                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                        <div class="avatar-item">
                                            <img alt="image"
                                                src="{{ asset('backend-assets/img/avatar/avatar-2.png') }}"
                                    ...
                                    <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                        <div class="avatar-item">
                                            <img alt="image"
                                                src="{{ asset('backend-assets/img/avatar/avatar-3.png') }}"
                                    ...
                                    <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                        <div class="avatar-item">
                                            <img alt="image"
                                                src="{{ asset('backend-assets/img/avatar/avatar-4.png') }}"
...
@push('scripts')
    ...
    <script src="{{ asset('backend-assets/js/page/components-user.js') }}"></script>
@endpush
