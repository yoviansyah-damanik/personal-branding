...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('backend-assets/library/ionicons201/css/ionicons.min.css') }}">
@endpush
...
@push('scripts')
    ...
    <script src="{{ asset('backend-assets/js/page/modules-ion-icons.js') }}"></script>
@endpush
