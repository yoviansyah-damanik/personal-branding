...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('backend-assets/library/weathericons/css/weather-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('backend-assets/library/weathericons/css/weather-icons-wind.min.css') }}">
@endpush
