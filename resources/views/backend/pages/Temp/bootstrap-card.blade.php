                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chocolat-parent">
                                    <a href="{{ asset('backend-assets/img/example-image.jpg') }}" class="chocolat-image"
                                        title="Just an example">
                                        <div data-crop-image="285">
                                            <img alt="image" src="{{ asset('backend-assets/img/example-image.jpg') }}"
                                                class="img-fluid">
                                        </div>
                                    </a>
                                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('backend-assets/library/jquery-ui-dist/jquery-ui.min.css') }}"></script>
