...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('backend-assets/library/flag-icon-css/css/flag-icon.min.css') }}">
@endpush
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('backend-assets/library/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('backend-assets/library/chart.js/dist/Chart.js') }}"></script>
