                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="images">
                                            <img src="{{ asset('backend-assets/img/payment/visa.png') }}" alt="visa">
                                            <img src="{{ asset('backend-assets/img/payment/jcb.png') }}" alt="jcb">
                                            <img src="{{ asset('backend-assets/img/payment/mastercard.png') }}"
                                                alt="mastercard">
                                            <img src="{{ asset('backend-assets/img/payment/paypal.png') }}" alt="paypal">
                                        </div>
                                    </div>
