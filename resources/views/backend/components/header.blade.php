        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">{{ __('Logged in') }}
                    {{ Carbon::parse(Auth::user()->last_login)->diffForHumans() }}</div>
                <a href="{{ route('dashboard.account.information') }}" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> {{ __('Account Information') }}
                </a>
                <a href="{{ route('dashboard.account.information') }}" class="dropdown-item has-icon">
                    <i class="fas fa-key"></i> {{ __('Password') }}
                </a>
                <a href="{{ route('dashboard.general') }}" class="dropdown-item has-icon">
